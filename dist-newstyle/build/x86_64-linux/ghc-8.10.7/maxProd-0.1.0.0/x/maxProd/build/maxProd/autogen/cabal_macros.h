...
/* package maxProd-0.1.0.0 */
#ifndef VERSION_maxProd
#define VERSION_maxProd "0.1.0.0"
#endif /* VERSION_maxProd */
#ifndef MIN_VERSION_maxProd
#define MIN_VERSION_maxProd(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_maxProd */
...
#define CURRENT_COMPONENT_ID "maxProd-0.1.0.0-inplace-maxProd"
